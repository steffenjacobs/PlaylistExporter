...
// Generiert: 2018.05.30 um 05:38:54 PM CEST 
//
...
public class Smil {
    ...
    protected Smil.Head head;
    @XmlElement(required = true)
    protected Smil.Body body;
     ...
     *     
     */
    public void setHead(Smil.Head value) {
        this.head = value;
    }
     ...
     *     
     */
    public void setBody(Smil.Body value) {
        this.body = value;
    }
    ...
    public static class Body {
         ...
         *     
         */
        public void setSeq(Smil.Body.Seq value) {
            this.seq = value;
        }
        ...
        public static class Seq {
            ...
            protected List<Smil.Body.Seq.Media> media;
             ...
             * {@link Smil.Body.Seq.Media }
             * 
             * 
             */
            public List<Smil.Body.Seq.Media> getMedia() {
                if (media == null) {
                    media = new ArrayList<Smil.Body.Seq.Media>();
                }
                return this.media;
            }
            ...
            public static class Media {
                ...
                /**
                 * Ruft den Wert der tid-Eigenschaft ab.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                ...
                /**
                 * Legt den Wert der tid-Eigenschaft fest.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
    ...
    public static class Head {
        ...
        protected List<Smil.Head.Meta> meta;
        @XmlElement(required = true)
         ...
         * 
         */
        public List<Smil.Head.Meta> getMeta() {
            if (meta == null) {
                meta = new ArrayList<Smil.Head.Meta>();
            }
            return this.meta;
        }
